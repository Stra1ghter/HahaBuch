...
public class AnalysisService(IDbContextFactory<ApplicationDbContext> dbContextFactory, VaultAccessor vaultAccessor) : IAnalysisService
{
    public async Task<List<CategoryYearTotalDto>> GetCategoryYearTotals(int year)
    {
        ...
        var query = context.Transactions
            ...
            .Select(g => new CategoryYearTotalDto
            {
                ...
                Category = g.First().Category != null ? g.First().Category!.Name : "(Uncategorized)",
